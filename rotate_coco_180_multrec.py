...
from lib.base import init_output_path, get_image_paths, get_annoation_data_fpath, get_subdir_paths
...
def rotate():
    ...
    print('Done rotating COCO data format data recordings (%s)' % output_path)
