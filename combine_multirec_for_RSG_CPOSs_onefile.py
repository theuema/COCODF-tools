...
if __name__ == '__main__':
    ...
    parser.add_argument('--cl-gtruth', action='store_true', help='combine center points of of the ground truth object pose projections from multiple recordings for RSG')
